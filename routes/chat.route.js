...
module.exports = (app) => {
    app.post("/api/v1/chat/send", [authJwt.verifyToken], chatController.sendMessage);
    app.get("/api/v1/chat/getUsersBasedOnRoles", [authJwt.verifyToken], chatController.getChatTabUsers);
